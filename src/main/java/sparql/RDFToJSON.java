...
import javajsonld.JsonLdOptions;
import javajsonld.JsonLdProcessor;


public class RDFToJSON {

    public void convertRdfToPrettyJson(){
        try(InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("output.ttl")){
